...
interface TransactionDetailTypes {
  data: TransactionTypes;
}
export default function TransactionContentDetail(
  props: TransactionDetailTypes
) {
  const { data } = props;
  const IMG = process.env.NEXT_PUBLIC_IMG;
  const tax = data.historyVoucherTopup.price * (10 / 100);
          ...
          <div className="main-content main-content-card overflow-auto">
            <section className="checkout mx-auto">
              ...
              <div className="payment pt-10 pb-10">
                ...
                <Row label="Type" value={data.historyPayment.paymentType} />
